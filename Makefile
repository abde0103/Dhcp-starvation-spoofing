...
clean: 
	rm -f $(REBUILDABLES) dhcp_usurpation dhcp_usurpation.o
...
#$(LINK_TARGET) : $(OBJS)
starvation : starvation.o header.o 
	gcc -g  -o  $@ $^ 
...
# Dependency Rules are often used to capture header file dependencies.
 ...
 dhcp_usurpation:dhcp_usurpation.o
	gcc -o dhcp_usurpation dhcp_usurpation.o

dhcp_usurpation.o:dhcp_usurpation.c
	gcc -c dhcp_usurpation.c
